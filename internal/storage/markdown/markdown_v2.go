...
// Template methods - all stubs for now (to be implemented in Task 4)
...
func (m *MarkdownV2) CreateTemplate(t storage.Template) error {
	return errors.New("not implemented: CreateTemplate will be implemented in Task 4")
}

// GetTemplate returns a template by ID.
// To be implemented in Task 4.
func (m *MarkdownV2) GetTemplate(id string) (storage.Template, error) {
	return storage.Template{}, errors.New("not implemented: GetTemplate will be implemented in Task 4")
}

// GetTemplateByName returns a template by name.
// To be implemented in Task 4.
func (m *MarkdownV2) GetTemplateByName(name string) (storage.Template, error) {
	return storage.Template{}, errors.New("not implemented: GetTemplateByName will be implemented in Task 4")
}

// ListTemplates returns all templates ordered by name ascending.
// To be implemented in Task 4.
func (m *MarkdownV2) ListTemplates() ([]storage.Template, error) {
	return []storage.Template{}, errors.New("not implemented: ListTemplates will be implemented in Task 4")
}
...
func (m *MarkdownV2) UpdateTemplate(id string, name string, content string, attributes map[string]string) (storage.Template, error) {
	return storage.Template{}, errors.New("not implemented: UpdateTemplate will be implemented in Task 4")
}

// DeleteTemplate deletes a template by ID.
// To be implemented in Task 4.
func (m *MarkdownV2) DeleteTemplate(id string) error {
	return errors.New("not implemented: DeleteTemplate will be implemented in Task 4")
}
